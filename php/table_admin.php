    ...
    <div class="side row">
      ...
      <div class="content" id="content_bar">
        <div class="heading container-fluid">
          <h4>Application Request Monitor</h4>
        </div>
        <div class="modal modal-xl fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <button type="button" class="btn btn-success saveData" data-bs-dismiss = "modal" id = "saveCar">Save Data</button>
        ...
        <div class="container-fluid">
          <div class="container-fluid cont0">
            ...
            <table class="table table-light" id="table_id">
              <thead>
                <tr class = "table-row-1 table-dark ">
                  ...
                  <th scope="col col-auto" id = "resp">Response</th>
                </tr>
              </thead>
              <tbody id="row_body">
...
<script type = "module" src="../js/get_table.js"></script>
</html>
